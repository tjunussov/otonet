...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template name="magazas">
    	...
    	<Row  ss:Index="3" ss:AutoFitHeight="0" ss:Height="17.4375">
            ...
            <Cell ss:MergeAcross="7" ss:StyleID="m103215796"><Data ss:Type="String">MAGAZA TOPLAM</Data></Cell>
            <xsl:for-each select="$AylarHeader">
                <Cell ss:MergeAcross="7" ss:StyleID="m103215796"><Data ss:Type="String"><xsl:value-of select="@BIRIM_NO"/> - <xsl:value-of select="@BIRIM_ADI"/></Data></Cell>
            </xsl:for-each>
    	</Row>
    	<Row ss:Height="22.5">
    		   <Cell ss:StyleID="s62" class="tarih"><Data ss:Type="String">TARIH</Data></Cell>
            ...
            <!--tbody class="toplam"-->
                <Row ss:Height="22.5">
                    <Cell ss:StyleID="s62" class="tarih"><Data ss:Type="String"><xsl:value-of select="@title"/></Data></Cell>
                    <xsl:call-template name="birim_values">
            ...
            <!--tfoot class="toplam"-->
    		<Row ss:Height="22.5">
    			<Cell ss:StyleID="s62" class="tarih"><Data ss:Type="String">TOPLAM</Data></Cell>
                <xsl:call-template name="birim_values">
    ...
    <xsl:template name="birim_values">
        ...
        <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:value-of select="$NET_SATIS"/></Data></Cell>
        <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:value-of select="$BUTCE"/></Data></Cell>
        <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:value-of select="$NET_SATIS_FIILI"/></Data></Cell>
        <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:call-template name="neg"><xsl:with-param name="value" select="$PROG_GORE_ARTIS"/></xsl:call-template>
            <xsl:value-of select="$PROG_GORE_ARTIS"/>%</Data></Cell>
        <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:call-template name="neg"><xsl:with-param name="value" select="$GY_GORE_ARTIS"/></xsl:call-template>
            <xsl:value-of select="$GY_GORE_ARTIS"/>%</Data></Cell>
        <xsl:if test="$ROW/MUSTERI_SAYISI">
            <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:value-of select="$MUSTERI_SAYISI"/></Data></Cell>
            <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:value-of select="$GY_MUSTERI_SAYISI"/></Data></Cell>
            <Cell ss:StyleID="s63"><Data ss:Type="String"><xsl:call-template name="neg"><xsl:with-param name="value" select="$MUSTERI_SAYISI_ARTIS"/></xsl:call-template>
                <xsl:value-of select="$MUSTERI_SAYISI_ARTIS"/>%</Data></Cell>
        </xsl:if>
     ...
     <xsl:template name="birim_titles">
        <Cell ss:StyleID="s62"><Data ss:Type="String">NET SATIŞ GEÇEN YIL</Data></Cell>
        <Cell ss:StyleID="s62"><Data ss:Type="String">NET SATIŞ BÜTÇE</Data></Cell>
        <Cell ss:StyleID="s62"><Data ss:Type="String">NET SATIS FİİLİ</Data></Cell>
        <Cell ss:StyleID="s62"><Data ss:Type="String">Prog.Göre Artış</Data></Cell>
        <Cell ss:StyleID="s62"><Data ss:Type="String">G.Yıla Göre Artış</Data></Cell>
        <Cell ss:StyleID="s62"><Data ss:Type="String">MUSTERI SAYISI</Data></Cell>
        <Cell ss:StyleID="s62"><Data ss:Type="String">MUSTERI SAYISI GEÇEN YIL</Data></Cell>
        <Cell ss:StyleID="s62"><Data ss:Type="String">G.Yıla Göre Artış</Data></Cell>
     </xsl:template>
    ...
    <xsl:template name="magaza-toplam">
         ...
         <r:root>
    		...
    		<xsl:for-each select="$Aylar">
                ...
                <Row ss:Height="22.5">
                    <Cell ss:StyleID="s62"><Data ss:Type="String"><xsl:value-of select="@title"/></Data></Cell>
                    <xsl:call-template name="birim_values">
    ...
    <xsl:template name="toptan-satis">
        ...
        <xsl:variable name="MtXML">
    		<Row ss:Height="22.5">
            	<Cell ss:StyleID="s62"><Data ss:Type="String">TOPTAN SATIS</Data></Cell>
    			<Cell ss:StyleID="s62"><Data ss:Type="String">NET SATIŞ GEÇEN YIL</Data></Cell>
                <Cell ss:StyleID="s62"><Data ss:Type="String">NET SATIŞ BÜTÇE</Data></Cell>
                <Cell ss:StyleID="s62"><Data ss:Type="String">NET SATIS FİİLİ</Data></Cell>
                <Cell ss:StyleID="s62"><Data ss:Type="String">Prog.Göre Artış</Data></Cell>
    ...
    <xsl:template name="sirket-toplam">
    	...
    	<xsl:variable name="MtXML">
    		<Row ss:Height="22.5">
            	<Cell ss:StyleID="s62"><Data ss:Type="String">SIRKET TOPLAM</Data></Cell>
    			<xsl:call-template name="birim_titles"/>
            </Row>
    ...
    <xsl:template name="sirket-toplam-kumule">
    	...
    	<xsl:variable name="MtXML">
            ...
            <xsl:variable name="ROWS" select="//ROWSET/ROW"/>
            <Row ss:Height="22.5">
                <Cell ss:StyleID="s62"><Data ss:Type="String">KUMULE</Data></Cell>
                <xsl:call-template name="birim_values">
